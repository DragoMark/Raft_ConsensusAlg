...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/mnt/n/Sem7/Subjects/Distributed Systems/raftos-master'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/mnt/n/Sem7/Subjects/Distributed Systems/raftos-master/bin/deactivate.nu'
